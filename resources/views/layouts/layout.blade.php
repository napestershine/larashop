                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="mainmenu pull-left">
                                <ul class="nav navbar-nav collapse navbar-collapse">
                                    ...
                                    <li><a href="{{url('products')}}" {{$page == 'products' ? 'class=active' : ''}}>Products</a>
                                    </li>
                                    <li><a href="{{url('blog')}}" {{$page == 'blog' ? 'class=active' : ''}}>Blog</a></li>
                                    <li><a href="{{url('contact-us')}}" {{$page == 'contact_us' ? 'class=active' : ''}}>Contact
                                            Us</a></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        ...
                        <p class="pull-right">Laravel implementation by <span><a target="_blank"
                                                                                 href="http://www.tutorials.kode-blog.com">Tutorials
                                    Kode Blog</a></span> | Designed by <span><a target="_blank" href="http://www.themeum.com">Themeum</a></span>
                        </p>
                    </div>
                </div>
            </div>
